...
config :ux_express, UxExpressWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ValJW8IjETYkA4ZwZLFC71ph1K3n7XeZ2ntg/Rub999akKUbNuz9B0G4fwTcg5ip",
  watchers: [
...
config :ux_express, UxExpressWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/ux_express_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ux_express, dev_routes: true
